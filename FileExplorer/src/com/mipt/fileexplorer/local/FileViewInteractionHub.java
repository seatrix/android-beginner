...
package com.mipt.fileexplorer.local;
...
import com.mipt.fileexplorer.local.FileListItem.ModeCallback;
import com.mipt.fileexplorer.local.FileOperationHelper.IOperationProgressListener;
import com.mipt.fileexplorer.local.FileSortHelper.SortMethod;
import com.mipt.fileexplorer.local.FileViewActivity.SelectFilesCallback;
import com.mipt.fileexplorer.local.TextInputDialog.OnFinishListener;
...
public class FileViewInteractionHub implements IOperationProgressListener {
    ...
    private com.mipt.fileexplorer.local.FileViewInteractionHub.Mode mCurrentMode;
