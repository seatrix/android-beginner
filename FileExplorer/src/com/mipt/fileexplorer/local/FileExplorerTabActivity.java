...
import com.mipt.fileexplorer.remote.nfs.NfsMainActivity;
import com.mipt.fileexplorer.remote.smb.SmbMainActivity;
...
public class FileExplorerTabActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         **/
        mTabsAdapter.addTab(bar.newTab().setText(R.string.tab_smb),
        		SmbMainActivity.class, null);
        
        mTabsAdapter.addTab(bar.newTab().setText(R.string.tab_nfs),
        		NfsMainActivity.class, null);        
