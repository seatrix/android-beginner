 ...
 * data adapter
 * 
 * @author liu_tianbao provide data for the list of thumbnail
 */
public class RemoveFilterAdapter extends BaseAdapter {
     ...
     * @param layout //data container layout
     */
     ...
     * 
     * @author qian_wei storage control
     */
    private static class ViewHolder {
        /**
         * @tag : begin modify by qian_wei 2011/7/6
