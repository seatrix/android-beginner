    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
	 ...
	 /*According to the view whether there is to initialize the controls in each data container*/
        ...
        if (f.isFile()) {
            ...
            holder.checkedTxt.setCompoundDrawablesWithIntrinsicBounds(R.drawable.mp3file, 0, 0, 0);
        } else if ("video/*".equals(f_type)) {
            holder.checkedTxt
                    .setCompoundDrawablesWithIntrinsicBounds(R.drawable.vediofile, 0, 0, 0);
        } else if ("apk/*".equals(f_type)) {
				holder.checkedTxt
                .setCompoundDrawablesWithIntrinsicBounds(R.drawable.list, 0, 0, 0);
			} else if ("image/*".equals(f_type)) {
				holder.checkedTxt.setCompoundDrawablesWithIntrinsicBounds(R.drawable.imgfile, 0, 0, 0);
			} else {
				 holder.checkedTxt
                 .setCompoundDrawablesWithIntrinsicBounds(R.drawable.otherfile, 0, 0, 0);
			}
		}
        // File type data icon
        else {
			 holder.checkedTxt.setCompoundDrawablesWithIntrinsicBounds(R.drawable.folder_file, 0, 0,
	                    0);
		}
